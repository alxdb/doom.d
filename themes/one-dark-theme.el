;;; one-dark-theme.el --- inspired by Atom One Dark -*- lexical-binding: t; no-byte-compile: t; -*-
;;
...
(def-doom-theme one-dark
  ...
  (((line-number &override) :foreground base4)
   ...
   ((font-lock-comment-face &override)
    :background (if one-dark-brighter-comments (doom-lighten bg 0.05)))
   (mode-line
